...
public class TestLibretto { // voglio tesatre i metodi della classe Libretto
	...
	public static void main(String[] args) {
		...
		libretto.add(new Voto("Chimica", 25, LocalDate.of(2019, 2, 10)));
		
		System.out.println(libretto);
		
		List<Voto> venticinque = libretto.LisatVotiUguali(25);
